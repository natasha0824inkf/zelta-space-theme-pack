...
| Theme | Vibe | String |
|-------|------|--------|
| Zelta Classic | Muted brass gold | `#1C2535,#243044,#C9A227,#1C2535,#243044,#E8EDF5,#C9A227,#D4580A` |
| Zelta Gold ⭐ | Bright logo yellow | `#1C2535,#243044,#F5C400,#1C2535,#243044,#E8EDF5,#F5C400,#F5C400` |
| Zelta Intense | Max gold, deep black | `#1A1F2E,#252D3D,#F5C400,#1A1F2E,#2A3040,#F5C400,#F5C400,#FF8C00` |
| Zelta Retro Terminal | Phosphor green CRT | `#0A0A0A,#0F1F0F,#00FF41,#0A0A0A,#0F1F0F,#00FF41,#00FF41,#FF4444` |
| Zelta Color Blind Safe | Blue & orange accessible | `#1C2535,#243044,#56B4E9,#1C2535,#243044,#FFFFFF,#E69F00,#D55E00` |
| Zelta Rust | Warm rust & terracotta | `#1C1008,#2E1A0A,#B7410E,#F5E6C8,#2E1A0A,#E8C99A,#D4830A,#8B2500` |
| Zelta Light | White with gold accents | `#F8F8F8,#EEEEEE,#F5C400,#1C2535,#E4E4E4,#1C2535,#27AE60,#E74C3C` |
| Zelta GitHub | GitHub dark green | `#0D1117,#161B22,#238636,#FFFFFF,#21262D,#C9D1D9,#3FB950,#F78166` |
| Zelta PHP | PHP purple | `#4F5B93,#3D4777,#F15340,#FFFFFF,#3D4777,#FFFFFF,#8892BF,#F15340` |
| Zelta Python | Python blue & yellow | `#306998,#1E4D78,#FFD43B,#306998,#1E4D78,#F4F4F4,#FFE873,#FFD43B` |
| Zelta High Contrast | Pure black & white | `#000000,#111111,#FFFFFF,#000000,#111111,#FFFFFF,#00FF00,#FF0000` |
| Zelta Nord | Arctic blue | `#2E3440,#3B4252,#88C0D0,#2E3440,#3B4252,#D8DEE9,#A3BE8C,#BF616A` |
| Zelta Groovy | 70s purple & orange | `#2D1B69,#3D2580,#FF6B35,#FFFFFF,#3D2580,#F7C59F,#FFD700,#FF1493` |
